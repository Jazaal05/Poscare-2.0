 ...
 * < -3 SD = Sangat Kurang (gizi buruk)
 * -3 to -2 SD = Kurang (gizi kurang)
 * -2 to +2 SD = Normal (gizi baik)
 * +2 to +3 SD = Lebih (berisiko)
 * > +3 SD = Sangat Lebih (obesitas)
 * ============================================================================
 */
...
$WHO_BB_U_LAKI = [
    ...
    [35, 9.9, 11.2, 12.6, 14.2, 16.0, 18.1, 20.6],
    ...
    [54, 11.8, 13.4, 15.3, 17.3, 19.8, 22.7, 26.0],
    [55, 11.9, 13.5, 15.4, 17.5, 20.0, 22.9, 26.3],
    [56, 12.0, 13.6, 15.5, 17.7, 20.2, 23.2, 26.6],
    [57, 12.1, 13.7, 15.6, 17.8, 20.4, 23.4, 26.9],
    [58, 12.1, 13.8, 15.8, 18.0, 20.6, 23.7, 27.2],
    [59, 12.2, 13.9, 15.9, 18.2, 20.8, 23.9, 27.5],
...
$WHO_BB_U_PEREMPUAN = [
    ...
    [49, 11.0, 12.4, 14.3, 16.4, 18.8, 21.8, 25.5],
    [50, 11.1, 12.6, 14.5, 16.6, 19.0, 22.1, 25.9],
    [51, 11.2, 12.7, 14.6, 16.8, 19.2, 22.4, 26.3],
    [52, 11.3, 12.8, 14.8, 17.0, 19.4, 22.7, 26.6],
    [53, 11.4, 12.9, 15.0, 17.2, 19.7, 22.9, 27.0],
    [54, 11.5, 13.0, 15.2, 17.3, 19.9, 23.2, 27.4],
    [55, 11.6, 13.2, 15.4, 17.5, 20.1, 23.5, 27.7],
    [56, 11.7, 13.3, 15.5, 17.7, 20.3, 23.8, 28.1],
    [57, 11.8, 13.4, 15.3, 17.8, 20.6, 24.1, 28.5],
...
$WHO_TB_U_PEREMPUAN = [
    ...
    [28, 78.8, 82.2, 85.7, 89.1, 92.5, 95.9, 99.4],
...
// BB/TB LAKI-LAKI (Simplified - 16 titik kunci)
$WHO_BB_TB_LAKI = [
...
// BB/TB PEREMPUAN (Simplified - 16 titik kunci)
$WHO_BB_TB_PEREMPUAN = [
