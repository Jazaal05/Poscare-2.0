        ...
        <form id="formEdit" onsubmit="submitEdit(event)">
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="text" id="editNamaAnak" name="nama_anak">
                </div>
                <div class="form-group">
                    <label>NIK Anak</label>
                    <input type="text" id="editNikAnak" name="nik_anak" maxlength="16">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="editHp" name="hp_kontak_ortu">
                </div>
                <div class="form-group" style="grid-column:1/-1">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="editNamaIbu" name="nama_ibu">
                </div>
                <div class="form-group">
                    <label>NIK Ibu</label>
                    <input type="text" id="editNikIbu" name="nik_ibu" maxlength="16">
                </div>
                <div class="form-group">
                    <label>Nama Ayah</label>
                    <input type="text" id="editNamaAyah" name="nama_ayah">
                </div>
                <div class="form-group">
                    <label>NIK Ayah</label>
                    <input type="text" id="editNikAyah" name="nik_ayah" maxlength="16">
                </div>
            </div>
            <div style="margin-top:20px;display:flex;gap:10px;justify-content:flex-end;">
...
async function openEdit(id) {
    ...
    document.getElementById('editRtRw').value        = anak.rt_rw || '';
