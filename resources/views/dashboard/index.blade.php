...
<div class="dashboard-grid">
    ...
    <div class="notification-card">
        ...
        <div class="notification-item" id="immunizationNotif">
            <h4><i class="fas fa-syringe"></i> Status Imunisasi Bulan Ini</h4>
...
async function loadDashboardStats() {
    try {
        ...
        if (labelEl)    labelEl.textContent      = `${imun.immunized_this_month} dari ${imun.total_anak} anak sudah imunisasi bulan ini`;
