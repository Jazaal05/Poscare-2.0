...
<nav class="navbar">
    <div class="navbar-inner">
        <a href="<?php echo e(route('landing')); ?>" class="navbar-logo">
            <img src="<?php echo e(asset('images/poscare-logo.png')); ?>" alt="PosCare">
            PosCare
        </a>
        <div class="navbar-actions">
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('dashboard')); ?>" class="btn-nav btn-nav-outline">
                    <i class="fas fa-tachometer-alt"></i> Dashboard
                </a>
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" class="btn-nav btn-nav-solid">
...
<section class="layanan-section">
    ...
    <div class="layanan-grid">
        ...
        <a href="<?php echo e(auth()->check() ? route('dashboard') : route('login')); ?>" class="layanan-card balita">
        ...
        <a href="<?php echo e(auth()->check() ? route('lansia.dashboard') : route('login')); ?>" class="layanan-card lansia">
...
<footer>
    <p>&copy; <?php echo e(date('Y')); ?> PosCare — Sistem Informasi Digital Posyandu. Dibuat untuk Posyandu Nganjuk.</p>
</footer>

</body>
</html>
<?php /**PATH C:\Users\asus\VSCode\poscare-laravel\resources\views/landing.blade.php ENDPATH**/ ?>