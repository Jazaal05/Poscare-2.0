...
<head>
    ...
    <link rel="icon" type="image/png" sizes="160x160" href="<?php echo e(asset('images/poscare-logo.png')); ?>">
    <link rel="shortcut icon" type="image/png" href="<?php echo e(asset('images/poscare-logo.png')); ?>">
...
<div class="video-background">
    <video id="bgVideo" autoplay loop muted playsinline preload="auto">
        <source src="<?php echo e(asset('images/login-bg.mp4')); ?>" type="video/mp4">
    </video>
</div>
...
<div class="login-container">
    <div class="login-card">
        <div class="login-logo">
            <img src="<?php echo e(asset('images/poscare-logo.png')); ?>"
                 alt="Logo PosCare"
                 class="logo-image"
...
document.getElementById('loginForm').addEventListener('submit', async function(e) {
    ...
    try {
        ...
        const response = await fetch('<?php echo e(route("auth.login")); ?>', {
            method: 'POST',
            headers: {
...
document.getElementById('requestOtpForm').addEventListener('submit', async function(e) {
    ...
    try {
        ...
        const response = await fetch('<?php echo e(route("auth.request-otp")); ?>', {
            method: 'POST',
...
document.getElementById('verifyOtpForm').addEventListener('submit', async function(e) {
    ...
    try {
        ...
        const response = await fetch('<?php echo e(route("auth.reset-password")); ?>', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json', 'X-CSRF-TOKEN': CSRF_TOKEN, 'Accept': 'application/json' },
            credentials: 'same-origin',
...
<?php /**PATH C:\Users\asus\VSCode\poscare-laravel\resources\views/auth/login.blade.php ENDPATH**/ ?>