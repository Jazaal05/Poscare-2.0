...
<?php $__env->startSection('title', 'Grafik Pertumbuhan - ' . $anak->nama_anak); ?>
...
<div style="margin-bottom:16px;">
    <a href="<?php echo e(route('anak.index')); ?>" style="color:#246BCE;text-decoration:none;font-size:14px;"><i class="fas fa-arrow-left"></i> Kembali ke Data Anak</a>
</div>

<h1 class="page-title"><i class="fas fa-chart-line" style="color:#246BCE;"></i> Grafik Pertumbuhan</h1>
<p class="page-subtitle"><?php echo e($anak->nama_anak); ?> — <?php echo e($anak->jenis_kelamin === 'L' ? 'Laki-laki' : 'Perempuan'); ?></p>


<div class="info-grid">
    <div class="info-card">
        <div class="label">Nama Anak</div>
        <div class="value" style="font-size:16px;"><?php echo e($anak->nama_anak); ?></div>
    </div>
    <div class="info-card">
        <div class="label">Tanggal Lahir</div>
        <div class="value" style="font-size:16px;"><?php echo e(\Carbon\Carbon::parse($anak->tanggal_lahir)->format('d/m/Y')); ?></div>
    </div>
    <div class="info-card">
        <div class="label">Usia Sekarang</div>
        <div class="value"><?php echo e($anak->umur_display); ?></div>
    </div>
    <div class="info-card">
        <div class="label">Status Gizi</div>
        <div class="value" style="font-size:15px;"><?php echo e($anak->status_gizi ?? 'Belum diukur'); ?></div>
    </div>
</div>
...
<div class="card">
    ...
    <form id="formPengukuran" onsubmit="submitPengukuran(event)">
        <input type="hidden" name="anak_id" value="<?php echo e($anak->id); ?>">
        <div class="form-row">
            <div class="form-group">
                <label>Tanggal Ukur <span style="color:red">*</span></label>
                <input type="date" name="tanggal_ukur" max="<?php echo e(date('Y-m-d')); ?>" value="<?php echo e(date('Y-m-d')); ?>" required>
            </div>
            <div class="form-group">
    ...
    <div style="overflow-x:auto;">
        <table class="riwayat-table">
            ...
            <tbody id="riwayatBody">
                ...
                <tr>
                    <td><?php echo e(\Carbon\Carbon::parse($r['tanggal_ukur'])->format('d/m/Y')); ?></td>
                    <td><?php echo e($r['umur_bulan']); ?></td>
                    <td><?php echo e($r['bb_kg']); ?></td>
                    <td><?php echo e($r['tb_pb_cm']); ?></td>
                    <td><?php echo e($r['lk_cm'] ?? '-'); ?></td>
                    <td><?php echo e(number_format($r['z_bbu'], 2)); ?></td>
                    <td><?php echo e(number_format($r['z_tbu'], 2)); ?></td>
                    <td><?php echo e(number_format($r['z_bbtb'], 2)); ?></td>
                    <td>
                        <?php
                        ...
                        ?>
                        <span class="badge badge-<?php echo e($cls); ?>"><?php echo e(ucfirst(str_replace('_', ' ', $s))); ?></span>
                    </td>
                </tr>
...
<script>
const riwayatData = <?php echo json_encode($riwayat, 15, 512) ?>;
...
async function submitPengukuran(e) {
    ...
    try {
        const res = await fetch('<?php echo e(route("pengukuran.store")); ?>', {
            method: 'POST',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\asus\VSCode\poscare-laravel\resources\views/pengukuran/grafik-baru.blade.php ENDPATH**/ ?>